...
<head>
	...
	<title>Burp Big || <?php echo @$Title;?></title>
...
<?php /*?>	<link rel="stylesheet" href="<?php echo base_url(); ?>common/bootstrap/css/bootstrap.min.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>common/dist/css/skins/_all-skins.min.css">
     <link rel="stylesheet" href="<?php echo base_url(); ?>common/custome.css">
  <!--end demo-->
...
<ul class="nav navbar-nav">
	...
	<img src="<?php echo SITE_URL; ?>upload/manager/<?php echo $profile['profile_pic']; ?>" class="user-image" alt="User Image">
	<?php }else{?>	
	...
	<?php if($profile['profile_pic']){ ?>	
	<img src="<?php echo SITE_URL; ?>upload/manager/<?php echo $profile['profile_pic']; ?>" class="img-circle" alt="User Image">
	<?php }else{?>	
