...
<a class="btn btn-primary" href="<?php echo site_url('banquets/add'); ?>"><i class="fa fa-plus-circle"></i> Add New Banquets</a>
<ol class="breadcrumb">
<li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
<li class="active">Add New Banquets</li>
</ol>
</section>	
...
<div class="box-header with-border">
	<h3 class="box-title">List of Banquets</h3>
...
<div class="box-body">
	...
	<tbody>
		<?php  foreach($allbanquets as $key=>$data){ ?>		
		<tr>
		<td><?php echo $key+1; ?></td>
		<td><?php //echo $data['banquets_name']; ?>demo</td>
		...
		<td><a class="btn btn-success" href="<?php  echo site_url('banquets/edit/'.$data['id']); ?>"><i class="fa fa-edit"></i> Edit</a>  
			<a class="btn btn-danger"  onclick="return confirm('Are you sure you want to delete')"  href="<?php  echo site_url('banquets/delete/'.$data['id']); ?>"><i class="fa fa-trash-o"></i> Delete</a>
