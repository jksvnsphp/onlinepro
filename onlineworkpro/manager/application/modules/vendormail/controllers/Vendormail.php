...
class Vendormail extends MY_Controller {
	
	function __construct(){
        parent::__construct();
		$this->load->model('Vendormail_model'); 
    }	

	public function index(){
		$data['get_mailbox'] = $this->Vendormail_model->getNewsletter();
        ...
        {	
			...
			if($result)
			{
				$msg = "Mail has been send to selected vendor";
