...
class Usermail extends MY_Controller {
	
	function __construct(){
        parent::__construct();
		$this->load->model('Usermail_model'); 
    }	

	public function index(){
		$data['get_mailbox'] = $this->Usermail_model->getNewsletter();
        ...
        {	
			...
			if($result)
			{
				$msg = "Mail has been send to selected user";
