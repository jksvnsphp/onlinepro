...
<a class="btn btn-primary" href="<?php echo site_url('subscriber/add'); ?>"><i class="fa fa-plus-circle"></i>  Add New Subscriber</a>
<ol class="breadcrumb">
...
<div class="box-body">
	...
	<tbody>	
		...
		<!--<td><?php echo $subscriber['modified_at']; ?></td>-->
		<td width="20%">
			<a class="btn btn-danger" href="<?php echo site_url('subscriber/delete/'.$subscriber['id']); ?>" onclick="return confirm('Are you sure you want to delete')"><i class="fa fa-trash-o"></i> Delete</a>
		</td>
		</tr>   
		<?php $i++; }?>
	</tbody>
