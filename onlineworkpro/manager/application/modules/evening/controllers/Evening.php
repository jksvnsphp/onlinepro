...
class Evening extends MY_Controller {
	...
	public function index(){		
	 ...
	 $food_type = 3;  //  e.q breakfast / lunch / dinner
     ...
     $data['dates_in_calender']  =$this->Evening_model->getHotelAvailabilityData($hotel_id, $food_type, '');
	...
	public function add()
	{
       ...
       /* $this->form_validation->set_error_delimiters('<div class="error">', '</div>');
        ...
        if ($this->form_validation->run() == true) {*/
		   ...
		   $resulhotaltval = $this->Evening_model->insertHotelAvailabilityData($uploaddata);	
  ...
  switch ($type) {   
    case "master_calender":
        ...
        $hotel_id = $_POST['hotel_id']; 
         $test = $this->Evening_model->getMasterHotelAvailabilityData($hotel_id, $date);
    ...
    case "single_calender":
        ...
        $food_type = $_POST['type_id'];
            $master = $this->Evening_model->getMasterHotelAvailabilityData($hotel_id, $date);
            $type = $this->Evening_model->getHotelAvailabilityData($hotel_id, $food_type, $date);
