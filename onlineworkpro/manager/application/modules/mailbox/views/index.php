...
<h1>Send mail to subscriber</h1>
<ol class="breadcrumb">
<li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
<li class="active">Send mail to subscriber</li>
</ol>
</section>
...
<form action="<?php echo site_url('mailbox/index'); ?>" method="post" role="form" class="form-horizontal" enctype="multipart/form-data">	
