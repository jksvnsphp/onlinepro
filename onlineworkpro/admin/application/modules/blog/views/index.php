...
<a class="btn btn-primary" href="<?php echo site_url('blog/add'); ?>"><i class="fa fa-plus-circle"></i> Add New Blog</a>
<ol class="breadcrumb">
...
<div class="box-body">
	...
	<tbody>	
		...
		<td><?php echo $blog['modified_at']; ?></td>
		<td width="20%">
			<a class="btn btn-success" href="<?php echo site_url('blog/edit/'.$blog['id']); ?>"><i class="fa fa-edit"></i> Edit</a>  
			<a class="btn btn-danger" href="<?php echo site_url('blog/delete/'.$blog['id']); ?>" onclick="return confirm('Are you sure you want to delete')"><i class="fa fa-trash-o"></i> Delete</a>
		</td>
		</tr>   
		<?php $i++; }?>
	</tbody>
