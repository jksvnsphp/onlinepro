...
<section class="content-header">
 <a class="btn btn-primary" href="<?php echo site_url('page/add'); ?>"><i class="fa fa-plus-circle"></i>  Add New Page</a>
<ol class="breadcrumb">
...
<div class="box-body">
	...
	<!--	<td>
			<?php foreach($allmenu as $menus){
				if($menus['id'] == $pages['postition_id']){
					echo $menus['position'];
				}
			}?>
		</td>
	...
	-->	
		...
		<td width="20%">
			<a class="btn btn-success" href="<?php echo site_url('page/edit/'.$pages['id']); ?>"><i class="fa fa-edit"></i> Edit</a>  
			<!--<a class="btn btn-danger" href="<?php echo site_url('page/delete/'.$pages['id']); ?>" onclick="return confirm('Are you sure you want to delete')"><i class="fa fa-trash-o"></i> Delete</a>-->
		</td>
		</tr>   
		<?php $i++; }?>
	</tbody>
