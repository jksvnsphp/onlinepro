...
<li class="active">Send mail to user</li>
</ol>
</section>
...
<form action="<?php echo site_url('usermail/index'); ?>" method="post" role="form" class="form-horizontal" enctype="multipart/form-data">	
