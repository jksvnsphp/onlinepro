...
<a class="btn btn-primary" href="<?php echo site_url('message/add'); ?>"><i class="fa fa-plus-circle"></i> Send Message</a>
<ol class="breadcrumb">
...
<div class="box-body">
	...
	<tbody>	
		...
		<td><?php echo $venue['created_at']; ?></td>
		<td><?php echo $venue['modified_at']; ?></td>
		<td width="20%">
			<!--<a class="btn btn-success" href="<?php echo site_url('message/edit/'.$venue['id']); ?>"><i class="fa fa-edit"></i> Edit</a>  -->
			<a class="btn btn-danger" href="<?php echo site_url('message/delete/'.$venue['id']); ?>" onclick="return confirm('Are you sure you want to delete')"><i class="fa fa-trash-o"></i> Delete</a>
		</td>
		</tr>   
		<?php $i++; }?>
	</tbody>
