...
<a class="btn btn-primary" href="<?php echo site_url('area/add'); ?>"><i class="fa fa-plus-circle"></i> Add New Area</a>
<ol class="breadcrumb">
...
<div class="box-header with-border">
	<h3 class="box-title">List of Area</h3>
...
<div class="box-body">
	...
	<tbody>	
		...
		<td width="20%">
			<a class="btn btn-success" href="<?php echo site_url('area/edit/'.$ct['id']); ?>"><i class="fa fa-edit"></i> Edit</a>  
			<a class="btn btn-danger" href="<?php echo site_url('area/delete/'.$ct['id']); ?>" onclick="return confirm('Are you sure you want to delete')"><i class="fa fa-trash-o"></i> Delete</a>
		</td>
		</tr>   
		<?php }?>
	</tbody>
