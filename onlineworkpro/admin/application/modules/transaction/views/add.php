		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="box box-primary">
					<div class="box-header with-border"><h3 class="box-title">Add New Transaction</h3></div>
						<form action="<?php echo site_url('transaction/add'); ?>" method="post" role="form" class="form-horizontal" enctype="multipart/form-data">	
							<div class="box-body">
								<div class="form-group">
								<label class="col-md-2 control-label">User</label>							<input type="hidden" id="pro_id" name="pro_id" value="<?php echo $permotional['pro_id'];  ?>" />
							...
							<div class="box-body">
								...
								<label class="col-md-2 control-label">TDS</label>
									<div class="col-md-7">	
									<input type="text" name="tds" id="tds" value="<?php echo set_value('tds'); ?>"  class="form-control" placeholder="Enter TDS">
							...
							<div class="box-body">
								...
								<label class="col-md-2 control-label">NEFT No.</label>
									<div class="col-md-7">	
									<input type="text" name="neft_nubber" id="neft_nubber" value="<?php echo set_value('neft_nubber'); ?>"  class="form-control" placeholder="Enter NEFT No.">
							...
							<div class="box-body">
								...
								<label class="col-md-2 control-label">Net Amount</label>
									<div class="col-md-7">	
									<input type="text" name="net_amount" id="net_amount" value="<?php echo set_value('net_amount'); ?>"  class="form-control" placeholder="Enter Net Amount" />
							...
							<div class="box-body">
								...
								<label class="col-md-2 control-label">Transfer Date</label>
									<div class="col-md-7">	
									<input type="text" class="form-control" id="datetimepicker" value="<?php echo set_value('transaction_date'); ?>"  name="transaction_date" placeholder="Choose Transfer Date"/>
							...
							<div class="box-body">
								...
								<label class="col-md-2 control-label">Admin Charge</label>
									<div class="col-md-7">	
									<input type="text" class="form-control" id="admin_charge" value="<?php echo set_value('admin_charge'); ?>"  name="admin_charge" placeholder="Enter Admin Charge"/>
