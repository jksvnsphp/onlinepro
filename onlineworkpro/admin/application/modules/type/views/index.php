...
<a class="btn btn-primary" href="<?php echo site_url('type/add'); ?>"><i class="fa fa-plus-circle"></i> Add New Type</a>
<ol class="breadcrumb">
...
<div class="box-body">
	...
	<tbody>
		<?php  foreach($alltype as $key=>$data){ ?>		
		<tr>
		...
		<td><a class="btn btn-success" href="<?php  echo site_url('type/edit/'.$data['id']); ?>"><i class="fa fa-edit"></i> Edit</a>  
			<a class="btn btn-danger"  onclick="return confirm('Are you sure you want to delete')"  href="<?php  echo site_url('type/delete/'.$data['id']); ?>"><i class="fa fa-trash-o"></i> Delete</a>
		</td>
		</tr>
		<?php  } ?>      
	</tbody>
